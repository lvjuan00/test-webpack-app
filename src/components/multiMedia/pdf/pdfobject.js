...
(function (root, factory) {
  ...
  const pdfobjectversion = '2.0.201604172'
  let supportsPDFs = null
  // declare functions
  let createAXO = null
  let isIE = null
  const supportsPdfMimeType = (typeof navigator.mimeTypes['application/pdf'] !== 'undefined')
  let supportsPdfActiveX = null
  let buildFragmentString = null
  let log = null
  let embedError = null
  let embed = null
  let getTargetElement = null
  let generatePDFJSiframe = null
  const isIOS = (function () { return (/iphone|ipad|ipod/i.test(navigator.userAgent.toLowerCase())) })()
  let generateEmbedElement = null
  ...
  embed = function (url, targetSelector, options) {
    ...
    if (forcePDFJS && PDFJS_URL) {
      ...
      if (PDFJS_URL) {
        ...
        fallbackHTML = (typeof fallbackLink === 'string') ? fallbackLink : fallbackHTMLdefault
